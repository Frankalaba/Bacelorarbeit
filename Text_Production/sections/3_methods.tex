...
So, the \cref{eq:GE_berechnung} can be slimmed down and rearranged to calculate a fix value for NE\textsubscript{x} for the corresponding year, because the part with NE\textsubscript{y} turns zero (see \cref{eq:NE_x_calc}).
