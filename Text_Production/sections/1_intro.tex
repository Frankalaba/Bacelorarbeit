...
The pressing situation of the planets "health" is a scientific consensus \citep{ipccClimateChange20222022, planetaryboundariessciencepbsciencePlanetaryHealthCheck2025}. Already we can see the impact in our day to day live that the taken projecteries over the last decades are to be proven true, so we can measure for example a temperature rise in Europe of 2.5\,°C towards preindustrial times as well as a higher frequency of \gls{compound} \citep{ionitaDroughtsHotterDroughts2026, c3s/ecmwfC3SWMOEuropeanState2026}. 
...
To standardize the international calculation of national \acrshort{ghg} emission, the \acrfull{ipcc} developed a guideline for the calculation for all emission sources and each \acrshort{ghg} in 2006 \parencite{IPCC_2006_complete_Guidline} with a refinement in 2019 \parencite{IPCC_2019_Chapter_EnterFE}.
