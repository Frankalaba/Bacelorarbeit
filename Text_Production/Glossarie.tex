...
\newglossaryentry{gross}{
	name=gross,
	description={In the context of climate change, the gross effect refers to the direct, physical influence of a greenhouse gas (such as methane) on the Earth's energy balance, considered in isolation. The net effect, by contrast, accounts for masking effects. For example,e caused by co-emitted cooling agents, such as aerosols released during methane extraction, which can partially offset the gross warming contribution},
	type=geo
}
