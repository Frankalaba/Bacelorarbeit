...
\newglossaryentry{markerless}{
	name={markerless mutagenesis},
	description={A genetic engineering approach that introduces targeted mutations into a genome without leaving behind a selectable marker gene (such as an antibiotic resistance gene) in the final strain. This is typically achieved through a combination of positive \gls{selection} and \gls{counterselection}, allowing the marker to be removed after successful genomic integration \citep{kleinMarkerlessMutagenesisEnables2025}}, 
	type = biochem
}

\newglossaryentry{counterselection}{
	name={counterselection},
	description={A selection strategy in molecular genetics used to select against cells carrying a specific genetic marker, typically by exposing cells to a compound that becomes toxic only in its presence. This allows for the selective survival of cells in which the marker has been lost or replaced, enabling markerless genetic manipulation, as opposed to conventional \gls{selection}},
	type=biochem
}

\newglossaryentry{selection}{
	name={selection},
	description={A selection strategy in molecular biology used to select only organisms that have been successfully transformed. Usually, an antibiotic resistance gene is used as a selection marker, enabling the successfully transformed organism to survive in the presence of an otherwise toxic antibiotic},
	type=biochem
}

\newglossaryentry{conjug}{
	name=conjugation,
	description={Conjugation is the process of horizontal gen-transfer between a donor-cell and an acceptor-cell. The connection or "mating" between the cells is made by a pilus (also called "sex-pilus"), which allows the transport of the DNA. The conjugation can also happen between different species or domains. Needed for the conjugation is a plasmid that contains the gene for conjugation (the \textit{tra}-region) and connection with a pilus \parencite[p.\,207]{fritscheMikrobiologie2024}}, 
	type=biochem}
...
\newglossaryentry{auxo}{name=auxotrophic,description= {Auxotrophic organism can not produce relevant bio-molecules for growth and surviving. Therefore, they must obtain these from their environment \parencite[p.\,65]{fritscheMikrobiologie2024}}, 
type=biochem}
...
\newglossaryentry{pha_con_mic}{
	...
	description={Phase-contrast microscopy is based on the fact, that objects or medium not only changes the amplitude of light but also the phase of it. The phase-contrast microscope makes this phenomena visual for the human eye \citep{pawlizakIntroductionPhaseContrast2009}},
	type=biochem
}

\newglossaryentry{plateing}{
	name={Plating},
	description= {Cultivate microorganism on a solid medium (contains a gelling agent like agar). The plating, therefore, is the process how the organism get distributed on the plate/solid media. Different technics are possible like spreading or pouring \citep[p. \,364]{fritscheMikrobiologie2024}},
	type=biochem}
...
\newglossaryentry{alphafold}{name=AlphaFold,description={Is a KI based software for predicting \gls{insilico} the 3-D structure of proteins. For the prediction it needs an amino acid sequence}, 
type=biochem}
...
\newglossaryentry{glove}{
	name={glove-box},
	description={A sealed, airtight chamber system with built-in gloves that allow you to work from the outside while the internal atmosphere remains controlled (e.g. a anaerobic atmosphere)},
	type=biochem}
...
\newglossaryentry{primer}{
	name=primer,
	description={Short nucleotide sequence that serves as a starting point for the polymerase to replicate the complementary DNA strand. For this purpose, the primer hybridizes to a specific sequence on the \acrlong{ssDNA} template \citep{fritscheMikrobiologie2024}},
	type=biochem
}
...
\newglossaryentry{invivo}{name=in-vivo,description= {Experiments are performed in/ at the living organism}, 
	type=biochem}
	
\newglossaryentry{insilico}{name=in-silico,description= {Investigations or experiments are performed on a computer/ via computer simulation software}, 
	type=biochem}
...
description={ANNEX-I and Non-ANNEX-I countries is a classification of the \acrshort{unfccc}. ANNEX-I are the \acrshort{oecd} countries or countries with an economy in transition}, 
type=geo}
...
\newglossaryentry{compound}{name=compound events,description={When two wether extremes occur at the same time or shortly after each other, so that they reinforce each other, as example a heatwave and droughts \citep{leeAnnexGlossary2023}}, 
type=geo }
...
\newglossaryentry{gross}{
	name=gross,
	description={In the context of climate change, the gross effect refers to the direct, physical influence of a greenhouse gas (such as methane) on the Earth's energy balance, considered in isolation. The alternative for the gross effect would be the \gls{net} effect},
	type=geo
}

\newglossaryentry{net}{
	name=net,
	description={ Contrary to the \gls{gross} effect accounts the net effect of \acrshort{ghg} also for masking effects. For example, caused by co-emitted cooling agents, such as aerosols released during methane extraction, which can partially offset the gross warming contribution},
	type=geo
}

\newglossaryentry{radForce}{name=radiative forcing,description={Is a concept that quantifies the change of the energy balance of the hole planet. The unit is W/m\textsuperscript{2}. It depends on many factors as e.g. aeorosol conten of the atmosphere, planetary albedo and the concentration of \acrshort{ghg} \parencite{irfanChapterEightRadiative2024}}, 
type=geo}
%%%%%%%%%%%%%%%%%%%"%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
